        ...
        <body>
            ...
            <table  boder="1">
                ...
                <xsl:for-each select="/QUANLYTHUVIEN/SACH">
                    <tr>                       
                        ...
                        <td><xsl:value-of select="MaPM"/></td>
                        <td><xsl:value-of select="TenSach"/></td>
                        <td><xsl:value-of select="TacGia"/></td>
                        <td><xsl:value-of select="TenLoaiSach"/></td>
                        <td><xsl:value-of select="NgonNgu"/></td>
                        <td><xsl:value-of select="SLNhap"/></td>
                        <td><xsl:value-of select="VITRIDATSACH"/></td>
            ...
            <table boder="1">
                ...
                <xsl:for-each select="/QUANLYTHUVIEN/NHANVIEN">
                    <tr>
                        ...
                        <td><xsl:value-of select="NgaySinhNV"/></td>
                        <td><xsl:value-of select="ĐiaChiNV"/></td>
                        <td><xsl:value-of select="SDTNV"/></td>
                        <td><xsl:value-of select="LuongNV"/></td>
                    </tr>
            ...
            <table boder="1">
                ...
                <xsl:for-each select="/QUANLYTHUVIEN/NHAXUATBAN">
                    <tr>
                        <td><xsl:value-of select="MaNXB"/></td>
                        <td><xsl:value-of select="TenNXB"/></td>
                        <td><xsl:value-of select="DiaChiNXB"/></td>
                        <td><xsl:value-of select="EmailNXB"/></td>
                        <td><xsl:value-of select="SDTNXB"/></td>
                    </tr>    
                </xsl:for-each>
            </table>
            ...
            <table boder="1">
                ...
                <xsl:for-each select="/QUANLYTHUVIEN/DOCGIA">
                    <tr>
                        <td><xsl:value-of select="MaDG"/></td>
                        <td><xsl:value-of select="MaTTV"/></td>
                        <td><xsl:value-of select="TenDG"/></td>
                        <td><xsl:value-of select="SDTDG"/></td>
                        <td><xsl:value-of select="GTDG"/></td>
                        <td><xsl:value-of select="NgaySinhDG"/></td>                        
                        <td><xsl:value-of select="NgayCapTTV"/></td>
                        <td><xsl:value-of select="NgayHetHan"/></td>
                    </tr>
                </xsl:for-each>
            </table>
            ...
            <table boder="1">
                ...
                <xsl:for-each select="/QUANLYTHUVIEN/PHIEUTHU">
                    <tr>
                        <td><xsl:value-of select="MaPT"/></td>
                        <td><xsl:value-of select="MaSACH"/></td>
                        <td><xsl:value-of select="NgayThu"/></td>
                        <td><xsl:value-of select="GiaTienThu"/></td>
                    </tr>
                </xsl:for-each>
            </table>           
            ...
            <table boder="1">
                <tr>
                    ...
                    <th>TienThuduoc</th>
                    <th>TongTien</th>
                    <xsl:variable name="TinhTongTien" select="number(substring(TienThuduoc,20,0)) - number(substring(LuongNV,20,0))"/>
                </tr> 
                <xsl:for-each select="/QUANLYTHUVIEN/BAOCAO">
                    <tr>
                        <td><xsl:value-of select="MaBC"/></td>
                        <td><xsl:value-of select="NgayBC"/></td>                       
                        <td><xsl:value-of select="TienThuduoc"/></td>
            ...
            <table boder="1">
                ...
                <xsl:for-each select="/QUANLYTHUVIEN/PHIEUMUON">
                    <tr>
                        ...
                        <td><xsl:value-of select="HanTra"/></td>
                    </tr>
                </xsl:for-each>
            </table>
        </body>
